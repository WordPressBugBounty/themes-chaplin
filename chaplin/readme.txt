...
- NEW: The lazy loading pagination is now limited to a whitelisted set of supported post types. It default to `post`, `page`, `product`, `jetpack-portfolio`, and `any` (search). It can be extended by hooking into the `chaplin_allowed_post_types_for_lazy_loading` filter.
